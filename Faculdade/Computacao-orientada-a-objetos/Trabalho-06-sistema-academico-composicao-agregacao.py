...
print(
    f'\nTotal de carga horária obrigatória cursada: {getCargaHorariaObrigatoria(Aluno1, Historico1, grade1, grade2)}')
print(
...
for historico in Historico2.getHistorico():
    ...
    print(f'Código: {historico.getCodigo()},  Disciplina: {historico.getNomeDisciplina()}, Carga horária: {historico.getCargaHoraria()}')
print(
    f'\nTotal de carga horária obrigatória cursada: {getCargaHorariaObrigatoria(Aluno2, Historico2, grade1, grade2)}')
print(
