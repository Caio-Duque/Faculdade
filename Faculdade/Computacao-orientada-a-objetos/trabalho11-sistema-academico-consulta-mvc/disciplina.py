...
class CtrlDisciplina():       
    def __init__(self):
        self.listaDisciplinas = [
            Disciplina('COM220', 'Programação orientada a objetos I'),
            Disciplina('COM111', 'Algoritmos e estrutura de dados I'),
    ...
    def enterHandler(self, event):
        try:
            ...
            self.limiteIns.mostraJanela('PARABENS!', 'DISCIPLINA CADASTRADA COM SUCESSO')
